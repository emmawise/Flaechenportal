...
$(function(){
	...
	if (check !=  dd ) {
		$(function(){
			...
			//$.get("./data/events.json",function(obj){	
...
//Abrufen der Veranstaltungen aus lokalem json, parsen, ausgabe in div mit id=doc-body (veranstaltungen.php)
$(function(){
	$content = $("#doc-body");
	$start1 = $("#event1");
	$start2 = $("#event2");
